...
const AddStaticPageForm = ({ onSubmit, onCancel, initialData = null }) => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "title") {
      setFormData((prev) => {
        const nextSlug = !slugManuallyEdited ? generateSlug(value) : prev.slug;
  ...
  const inputClasses = "w-full bg-transparent text-sm font-medium text-[#111827] outline-none placeholder:text-slate-400";
