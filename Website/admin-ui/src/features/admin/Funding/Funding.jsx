...
export default function Funding() {
  ...
  const fetchFundingRequests = useCallback(async () => {
    ...
    try {
      ...
      // FIXED: Using standard fetch instead of invoke!
  ...
  // FIXED: Added base variable and Offer Under Review status
        ...
        {showDetails ? (
            <FundingDetails
                ...
                onBack={() => {
                  ...
                  fetchFundingRequests(); // This now works because fetchFundingRequests is fixed!
                }}
            />
        ) : (
            <>
                    ...
                    <div className="overflow-x-auto font-sans">
                      <table className="w-full text-left border-collapse min-w-[900px]">
                        ...
                        <tr className="bg-[#F6FAFC] border-b border-[#D6E4EA] text-[#526274] text-xs font-bold uppercase tracking-wider">
                          ...
                          <th className="p-4">Offered Amount</th>
                        ...
                        {filteredRequests.map((request) => (
                            <tr key={request.id} className="hover:bg-[#F6FAFC] transition-colors">
                              ...
                              <td className="p-4 text-sm font-extrabold text-[#006F9E] font-['Space_Grotesk']">
                                {request.approved_amount ? (
                                    <span className="text-green-600">
                               ${parseFloat(request.approved_amount).toLocaleString("en-US", { maximumFractionDigits: 0 })}
                             </span>
                                ) : (
