...
import { Plus, FileText, Link2, Search, Loader2, Inbox, X } from "lucide-react";
    ...
    <div className="space-y-6 font-sans">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-5">
          <div className="space-y-3">
            ...
            <p className="text-sm text-white/85 max-w-2xl leading-relaxed">
              Terms, policies, and other one-off pages on the public site — editable without a code deploy.
            </p>
          </div>
          <button
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-2xl border border-[#D6E4EA] text-center p-6">
          ...
          <h3 className="text-lg font-bold text-[#111827]">No static pages yet</h3>
          <p className="text-xs text-[#526274] mt-1 max-w-sm">
            Create your first one — Terms & Conditions is already handled separately, so try FAQ or Privacy Policy.
          </p>
          <button
            onClick={() => setShowForm(true)}
